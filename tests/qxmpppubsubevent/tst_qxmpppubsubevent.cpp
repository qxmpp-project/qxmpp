...
#define ROW(name, xml, type, node, retractIds, redirectUri, subscription, items, configForm) \
    ...
    ROW("items",
        ...
        QString(),
        std::nullopt,
        QList<QXmppPubSubItem>() << QXmppPubSubItem("ae890ac52d0df67ed7cfdf51b644e901"),
        std::nullopt);
    ...
    ROW("retract",
        ...
        QXmppPubSubEventBase::Items,
        "princely_musings",
        QStringList() << "ae890ac52d0df67ed7cfdf51b644e901" << "34324897shdfjk948577342343243243",
        QString(),
        std::nullopt,
        QList<QXmppPubSubItem>(),
        std::nullopt);
    ...
    ROW("subscription-expiry",
        "<message id=\"foo\" type=\"normal\">"
        "<event xmlns=\"http://jabber.org/protocol/pubsub#event\">"
        "<subscription jid=\"francisco@denmark.lit\" node=\"princely_musings\" subid=\"ba49252aaa4f5d320c24d3766f0bdcade78c78d3\" subscription=\"subscribed\" expiry=\"2006-02-28T23:59:59Z\"/>"
        "</event>"
        "</message>",
        QXmppPubSubEventBase::Subscription,
        QString(),
