...
///
/// \param channelJid JID of the channel that is joined by the user or for which the participant changed the nick
...
{
    auto itr = std::find_if(d->services.begin(), d->services.end(), [&jid = service.jid](const Service &service) {
