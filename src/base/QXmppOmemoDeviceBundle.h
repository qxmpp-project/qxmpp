...
public:
    ...
    int signedPublicPreKeyId() const;
    void setSignedPublicPreKeyId(const int id);

    QByteArray signedPublicPreKeySignature() const;
    void setSignedPublicPreKeySignature(const QByteArray &signature);

    QMap<int, QByteArray> publicPreKeys() const;
    void setPublicPreKeys(const QMap<int, QByteArray> &keys);
