...
public:
    ...
    int signedPublicPreKeyId = 0;
    QByteArray signedPublicPreKeySignature;
    QMap<int, QByteArray> publicPreKeys;
};
...
///
int QXmppOmemoDeviceBundle::signedPublicPreKeyId() const
{
...
///
void QXmppOmemoDeviceBundle::setSignedPublicPreKeyId(const int id)
{
    if (id > 0) {
...
///
/// The key of a key-value pair represents the ID of the corresponding public pre key.
///
/// \return the public pre keys
///
QMap<int, QByteArray> QXmppOmemoDeviceBundle::publicPreKeys() const
{
...
///
/// The key of a key-value pair represents the ID of the corresponding public pre key.
/// The ID must be a positive value, otherwise the corresponding key-value pair is ignored.
///
/// \param keys public pre keys
///
void QXmppOmemoDeviceBundle::setPublicPreKeys(const QMap<int, QByteArray> &keys)
{
